    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('davlat', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='statsAPP.davlat')),
            ],
            options={
                'verbose_name': 'Club',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='statsAPP.club')),
                ('davlat', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='statsAPP.davlat')),
            ],
            options={
                'verbose_name': 'Player',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club_eski', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='eskilar', to='statsAPP.club')),
                ('club_yangi', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='yangilar', to='statsAPP.club')),
                ('player', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='statsAPP.player')),
            ],
            options={
